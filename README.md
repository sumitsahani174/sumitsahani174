...
<p align="center">
  ...
  <a href="mailto:sumitsahani174@gmail.com">
...
👋 Hi, I’m **Sumit Sahani**, a **Full-Stack .NET Developer with 6+ years of experience** in building **enterprise-scale, high-performance, cloud-native applications**.

I specialize in **.NET Core, ASP.NET Core, React.js, Node.js**, and **Microservices Architecture on Microsoft Azure**.  
Strong expertise in **REST APIs, database optimization, Redis caching, Kafka messaging, Docker, Kubernetes**, and **CI/CD pipelines**.

I consistently deliver **scalable, secure, production-ready systems** with measurable business impact while working in **Agile / Scrum environments**.

📍 Mumbai, India  
📧 sumitsahani174@gmail.com  
...
![AKS](https://img.shields.io/badge/AKS-326CE5?style=for-the-badge&logo=kubernetes)
![Docker](https://img.shields.io/badge/Docker-2496ED?style=for-the-badge&logo=docker)
![CI/CD](https://img.shields.io/badge/Azure_DevOps-CI/CD-0078D7?style=for-the-badge)
...
- Designed **cloud-native microservices** on AKS using .NET Core 6
- Reduced **policy processing time by 50%** using Redis caching
- Improved **DB performance by 35%** (Oracle & PostgreSQL)
- Automated CI/CD using **Azure DevOps**, reducing release cycles by 45%
- **5,000+ active users**, zero downtime production systems

---

### 🏢 Thyrocare Technologies Ltd. (2019 – 2022)
**Full-Stack Developer**

- Built APIs handling **10,000+ daily users**
- Led Agile team with **99.9% uptime**
- Reduced booking time by **60%**
- Developed **25+ secure healthcare APIs**
...
📜 Scaler Masterclass (System Design)  
